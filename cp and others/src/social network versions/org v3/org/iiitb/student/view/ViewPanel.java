...
public class ViewPanel extends JPanel implements ActionListener,
	...
	public ViewPanel(List<Student> l, Student stud){
		...
		JPanel fl0 = new JPanel(new WrapLayout(FlowLayout.RIGHT,60,0));
...
//		jl.add(hpanel);
		for (Student student : l) {
		    ...
		    jname.setFont(new Font("Algerian", Font.BOLD, 30));
		    JLabel jcourses = new JLabel(student.getCourses());
		    jcourses.setFont(new Font("Algerian", Font.BOLD, 30));
		    JLabel jgender = new JLabel(student.getGender().equals("M") || student.getGender().equals("m")?"Male" : "Female");
		    jgender.setFont(new Font("Algerian", Font.BOLD, 30));
		    jp.add(jimg);
		    jp.add(jname);
		    jp.add(jcourses);
		    jp.add(jgender);
